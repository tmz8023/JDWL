...
<div class="login-box f-mt10 f-pb50">
	<div class="main bgf">    
    	<div class="reg-box-pan display-inline">  
            ...
            <form action="zhuce_addZhuce.action" method="post">
	        	<div class="reg-box" id="verifyCheck" style="margin-top:20px;">
	            	<div class="part1">                	
	                    <div class="item col-xs-12">
	                        <span class="intelligent-label f-fl"><b class="ftx04">*</b>用户名：</span>    
	                        <div class="f-fl item-ifo">
	                            <input name="zhuce1" type="text" maxlength="20" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:3-20||isUname" data-error="用户名不能为空||用户名长度3-20位||只能输入中文、字母、数字、下划线，且以中文或字母开头" id="adminNo" />                            <span class="ie8 icon-close close hide"></span>
	                    ...
	                    <div class="item col-xs-12">
	                        ...
	                        <div class="f-fl item-ifo">
	                            <input name="zhuce2" type="text" class="txt03 f-r3 required" keycodes="tel" tabindex="2" data-valid="isNonEmpty||isPhone" data-error="手机号码不能为空||手机号码格式不正确" maxlength="11" id="phone" /> 
	                    ...
	                    <div class="item col-xs-12">
	                        ...
	                        <div class="f-fl item-ifo">
	                            <input name="zhuce3" type="password" id="password" maxlength="20" class="txt03 f-r3 required" tabindex="3" style="ime-mode:disabled;" onpaste="return  false" autocomplete="off" data-valid="isNonEmpty||between:6-20||level:2" data-error="密码不能为空||密码长度6-20位||该密码太简单，有被盗风险，建议字母+数字的组合" /> 
	                ...
	                <div class="part2" style="display:none">
	                    ...
	                    <div class="item col-xs-12 f-mb10" style="height:auto">
	                        ...
	                        <div class="f-fl item-ifo c-blue" id="verifyNo1">
	                ...
	                <div class="part3" style="display:none">
	                	<div class="item col-xs-12">
	                        ...
	                        <div class="f-fl item-ifo">
	                            <input id="zhuce4"name="zhuce4"type="text" maxlength="10" class="txt03 f-r3 required" tabindex="1" data-valid="isNonEmpty||between:2-10||isZh" data-error="真实姓名不能为空||真实姓名长度2-10位||只能输入中文" id="adminNo" />   
	                            <span class="ie8 icon-close close hide"></span>                         
	                            <label class="icon-sucessfill blank hide"></label>
	                    ...
	                    <div class="item col-xs-12">
	                        ...
	                        <div class="f-fl item-ifo">
	                            <input id="zhuce5" name="zhuce5" type="text" class="txt03 f-r3 required" tabindex="2" data-valid="isNonEmpty||isCard" data-error="身份证号不能为空||身份证号码格式不正确" maxlength="18"/>    
	                            <span class="ie8 icon-close close hide"></span>                        
	                            <label class="icon-sucessfill blank hide"></label>
	                    ...
	                    <div class="item col-xs-12">
	                        <span class="intelligent-label f-fl">&nbsp;</span>    
	                        <div class="f-fl item-ifo">
	                           <input type="submit"  class="btn btn-blue f-r3" id="sub" value="提交">                         
	                        </div>
	                    </div>
	                </div>  
	                <!-- <div class="part4 text-center" style="display:none">
	                	<h3>恭喜!您已注册成功！</h3>
	                    <p class="c-666 f-mt30 f-mb50">页面将在 <strong id="times" class="f-size18">10</strong> 秒钟后，跳转到 <a href="denglu.jsp" class="c-blue">登录中心</a></p>
	                </div> -->        
	            </div>
	         </form>
        </div>
...
$(function(){	
	...
	$("#btn_part2").click(function(){			
		...
		$(".part2").hide();
		$(".part3").show();	
		$("#btn_part3").innerHTML="提交";
	});	
	//第三页的确定按钮
	$("#sub").click(function(){			
		var zhuce4=$("#zhuce4").val();
		var zhuce5=$("#zhuce5").val();
		var sn=/[\u4e00-\u9fa5]/;
		var st = /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X)$/;
		if(!sn.test(zhuce4)){
			return false;
		}else if(!st.test(zhuce5)){
			return false;
		}else{
			alert("恭喜你；注册成功！");
			alert("立即登录");
...
$("#btn_part1").click(function(){
	var phone=$("#phone").val();
	document.getElementById("verifyNo1").innerHTML=phone;
